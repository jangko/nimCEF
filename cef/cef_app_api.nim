import cef_base_api, cef_command_line_api, cef_scheme_api, cef_request_api
import cef_render_process_handler_api, cef_resource_bundle_handler_api
import cef_browser_process_handler_api

export cef_command_line_api, cef_scheme_api
export cef_render_process_handler_api, cef_resource_bundle_handler_api
export cef_browser_process_handler_api
...
proc cef_execute_process*(args: ptr cef_main_args,
    application: ptr cef_app, windows_sandbox_info: pointer): cint {.cef_import.}
...
proc cef_initialize*(args: ptr cef_main_args,
    ...
    windows_sandbox_info: pointer): cint {.cef_import.}
...
proc cef_set_osmodal_loop*(osModalLoop: cint) {.cef_import.}
