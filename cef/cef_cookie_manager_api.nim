import cef_base_api, cef_callback_api
include cef_import
...
type
  ...
  cef_cookie_visitor* = object
    ...
    visit*: proc(self: ptr cef_cookie_visitor,
        cookie: ptr cef_cookie, count, total: cint,
        deleteCookie: var cint): cint {.cef_callback.}
...
proc cef_cookie_manager_create_manager*(path: ptr cef_string, persist_session_cookies: cint,
