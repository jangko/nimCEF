...
type
  ...
  cef_display_handler* = object
    ...
    on_tooltip*: proc(self: ptr cef_display_handler,
      browser: ptr_cef_browser, text: ptr cef_string): cint {.cef_callback.}
    ...
    on_console_message*: proc(self: ptr cef_display_handler,
      browser: ptr_cef_browser, message, source: ptr cef_string, line: cint): cint {.cef_callback.}
