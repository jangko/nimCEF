...
type
  ...
  cef_domdocument* = object
    ...
    has_selection*: proc(self: ptr cef_domdocument): cint {.cef_callback.}
  ...
  cef_domnode* = object
    ...
    is_text*: proc(self: ptr cef_domnode): cint {.cef_callback.}
    ...
    is_form_control_element*: proc(self: ptr cef_domnode): cint {.cef_callback.}
    ...
    # object.
    is_same*: proc(self, that: ptr cef_domnode): cint {.cef_callback.}
    ...
    set_value*: proc(self: ptr cef_domnode, value: ptr cef_string): cint {.cef_callback.}
    ...
    has_element_attributes*: proc(self: ptr cef_domnode): cint {.cef_callback.}
    ...
    # on success.
    set_element_attribute*: proc(self: ptr cef_domnode, attrName, value: ptr cef_string): cint {.cef_callback.}
