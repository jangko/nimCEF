...
proc cef_add_cross_origin_whitelist_entry*(
  source_origin: ptr cef_string, target_protocol: ptr cef_string,
  target_domain: ptr cef_string, allow_target_subdomains: cint): cint {.cef_import.}


# Remove an entry from the cross-origin access whitelist. Returns false (0) if
# |source_origin| is invalid or the whitelist cannot be accessed.

proc cef_remove_cross_origin_whitelist_entry*(
  source_origin: ptr cef_string, target_protocol: ptr cef_string,
  target_domain: ptr cef_string, allow_target_subdomains: cint): cint {.cef_import.}
...
proc cef_clear_cross_origin_whitelist*(): cint {.cef_import.}
