...
template cef_string_wide_copy*(src, src_len, output): cint = cef_string_wide_set(src, src_len, output, true)
template cef_string_utf8_copy*(src, src_len, output): cint = cef_string_utf8_set(src, src_len, output, true)
template cef_string_utf16_copy*(src, src_len, output): cint = cef_string_utf16_set(src, src_len, output, true)
