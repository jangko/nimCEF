...
type
  cef_browser* = object
    ...
    can_go_back*: proc(self: ptr cef_browser): int {.cef_callback.}
    
    # Navigate backwards.
    go_back*: proc(self: ptr cef_browser) {.cef_callback.}
  
    # Returns true (1) if the browser can navigate forwards.
    can_go_forward*: proc(self: ptr cef_browser): int {.cef_callback.}
    
    # Navigate forwards.
    go_forward*: proc(self: ptr cef_browser) {.cef_callback.}
    
    # Returns true (1) if the browser is currently loading.
    is_loading*: proc(self: ptr cef_browser): int {.cef_callback.}
    ...
    get_identifier*: proc(self: ptr cef_browser): int {.cef_callback.}
  
    # Returns true (1) if this object is pointing to the same handle as |that|
    # object.
    is_same*: proc(self: ptr cef_browser,
      that: ptr cef_browser): int {.cef_callback.}
  
    # Returns true (1) if the window is a popup window.
    is_popup*: proc(self: ptr cef_browser): int {.cef_callback.}
    
    # Returns true (1) if a document has been loaded in the browser.
    has_document*: proc(self: ptr cef_browser): int {.cef_callback.}
  ...
  cef_browser_host* = object
    ...
    # information.
    close_browser*: proc(self: ptr cef_browser_host, force_close: int) {.cef_callback.}
  
    # Set whether the browser is focused.
    set_focus*: proc(self: ptr cef_browser_host, focus: int) {.cef_callback.}
  
    # Set whether the window containing the browser is visible
    # (minimized/unminimized, app hidden/unhidden, etc). Only used on Mac OS X.
    set_window_visibility*: proc(self: ptr cef_browser_host, visible: int) {.cef_callback.}
    ...
    run_file_dialog*: proc(self: ptr cef_browser_host,
      ...
      accept_filters: cef_string_list, selected_accept_filter: int,
    ...
    find*: proc(self: ptr cef_browser_host, identifier: int,
      searchText: ptr cef_string, forward, matchCase: int,
      findNext: int) {.cef_callback.}
    
    # Cancel all searches that are currently going on.
    stop_finding*: proc(self: ptr cef_browser_host,
      clearSelection: int) {.cef_callback.}
    ...
    send_mouse_click_event*: proc(self: ptr cef_browser_host,
      ...
      mouseUp: bool, clickCount: int) {.cef_callback.}
    ...
    send_mouse_wheel_event*: proc(self: ptr cef_browser_host,
       event: ptr cef_mouse_event, deltaX, deltaY: int) {.cef_callback.}
    ...
    get_windowless_frame_rate*: proc(self: ptr cef_browser_host): int {.cef_callback.}
    ...
    set_windowless_frame_rate*: proc(self: ptr cef_browser_host, frame_rate: int) {.cef_callback.}
    ...
    drag_source_ended_at*: proc(self: ptr cef_browser_host,
      x, y: int, op: cef_drag_operations_mask) {.cef_callback.}
  ...
  cef_run_file_dialog_callback* = object
    ...
    on_file_dialog_dismissed*: proc(self: ptr cef_run_file_dialog_callback, 
      selected_accept_filter: int, file_paths: cef_string_list) {.cef_callback.}
  ...
  cef_navigation_entry_visitor* = object
    ...
    visit*: proc(self: ptr cef_navigation_entry_visitor,
      entry: ptr cef_navigation_entry, current, index, total: int): int {.cef_callback.}
...
proc cef_browser_host_create_browser*(windowInfo: ptr cef_window_info, client: ptr cef_client,
  ...
  request_context: ptr cef_request_context): int {.cef_import.}
