import cef_base, cef_frame, cef_menu_model
include cef_import
...
type
  ...
  cef_run_context_menu_callback* = object
    ...
    cont*: proc(self: ptr cef_run_context_menu_callback,
      command_id: int, event_flags: cef_event_flags) {.cef_callback.}
  ...
  cef_context_menu_handler* = object
    ...
    run_context_menu*: proc(self: ptr cef_context_menu_handler,
        ...
        callback: ptr cef_run_context_menu_callback): int {.cef_callback.}
    ...
    on_context_menu_command*: proc(self: ptr cef_context_menu_handler, 
      ...
      command_id: int, event_flags: cef_event_flags): int {.cef_callback.}
  ...
  cef_context_menu_params* = object
    ...
    get_xcoord*: proc(self: ptr cef_context_menu_params): int {.cef_callback.}

    # Returns the Y coordinate of the mouse where the context menu was invoked.
    # Coords are relative to the associated RenderView's origin.
    get_ycoord*: proc(self: ptr cef_context_menu_params): int {.cef_callback.}
    ...
    # NULL contents.
    has_image_contents*: proc(self: ptr cef_context_menu_params): int {.cef_callback.}
    ...
    # is one.
    get_dictionary_suggestions*: proc(self: ptr cef_context_menu_params, suggestions: cef_string_list): int {.cef_callback.}
  
    # Returns true (1) if the context menu was invoked on an editable node.
    is_editable*: proc(self: ptr cef_context_menu_params): int {.cef_callback.}
  
    # Returns true (1) if the context menu was invoked on an editable node where
    # spell-check is enabled.
    is_spell_check_enabled*: proc(self: ptr cef_context_menu_params): int {.cef_callback.}
    ...
    # items).
    is_custom_menu*: proc(self: ptr cef_context_menu_params): int {.cef_callback.}
  
    # Returns true (1) if the context menu was invoked from a pepper plugin.
    is_pepper_menu*: proc(self: ptr cef_context_menu_params): int {.cef_callback.}