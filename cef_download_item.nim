...
type
  ...
  cef_download_item* = object
    ...
    is_valid*: proc(self: ptr cef_download_item): int {.cef_callback.}
  
    # Returns true (1) if the download is in progress.
    is_in_progress*: proc(self: ptr cef_download_item): int {.cef_callback.}
  
    # Returns true (1) if the download is complete.
    is_complete*: proc(self: ptr cef_download_item): int {.cef_callback.}
  
    # Returns true (1) if the download has been canceled or interrupted.
    is_canceled*: proc(self: ptr cef_download_item): int {.cef_callback.}
    ...
    # unknown.
    get_percent_complete*: proc(self: ptr cef_download_item): int {.cef_callback.}
