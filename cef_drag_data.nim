...
type
  cef_drag_data* = object
    ...
    is_read_only*: proc(self: ptr cef_drag_data): int {.cef_callback.}

    # Returns true (1) if the drag data is a link.
    is_link*: proc(self: ptr cef_drag_data): int {.cef_callback.}

    # Returns true (1) if the drag data is a text or html fragment.
    is_fragment*: proc(self: ptr cef_drag_data): int {.cef_callback.}

    # Returns true (1) if the drag data is a file.
    is_file*: proc(self: ptr cef_drag_data): int {.cef_callback.}
    ...
    get_file_names*: proc(self: ptr cef_drag_data,
      names: cef_string_list): int {.cef_callback.}
