import cef_base, cef_string_visitor, cef_request
include cef_import
...
type
  cef_frame* = object
    ...
    is_valid*: proc(self: ptr cef_frame): int {.cef_callback.}
    ...
    execute_java_script*: proc(self: ptr cef_frame,
      code, script_url: ptr cef_string, start_line: int) {.cef_callback.}

    # Returns true (1) if this is the main (top-level) frame.
    is_main*: proc(self: ptr cef_frame): int {.cef_callback.}
  
    # Returns true (1) if this is the focused frame.
    is_focused*: proc(self: ptr cef_frame): int {.cef_callback.}
