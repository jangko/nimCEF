...
type
  ...
  cef_geolocation_callback* = object
    ...
    cont*: proc(self: ptr cef_geolocation_callback, allow: int): int {.cef_callback.}
  ...
  cef_geolocation_handler* = object
    ...
    on_request_geolocation_permission*: proc(self: ptr cef_geolocation_handler, 
      browser: ptr_cef_browser, requesting_url: ptr cef_string, request_id: int,
      callback: ptr cef_geolocation_callback): int {.cef_callback.}
    ...
    on_cancel_geolocation_permission*: proc(self: ptr cef_geolocation_handler, 
      browser: ptr_cef_browser, request_id: int) {.cef_callback.}
