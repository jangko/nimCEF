import cef_base, cef_frame, cef_string
include cef_import
...
type 
  cef_life_span_handler* = object 
    ...
    on_before_popup*: proc(self: ptr cef_life_span_handler,
    ...
    run_modal*: proc(self: ptr cef_life_span_handler, browser: ptr_cef_browser): int {.cef_callback.}
    ...
    # browsers
    #     exist.
    do_close*: proc(self: ptr cef_life_span_handler, browser: ptr_cef_browser): int {.cef_callback.}
    ...
    on_before_close*: proc(self: ptr cef_life_span_handler, browser: ptr_cef_browser) {.cef_callback.}