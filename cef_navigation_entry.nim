...
type
  ...
  cef_navigation_entry* = object
    ...
    is_valid*: proc(self: ptr cef_navigation_entry): int {.cef_callback.}
    ...
    has_post_data*: proc(self: ptr cef_navigation_entry): int {.cef_callback.}
    ...
    get_http_status_code*: proc(self: ptr cef_navigation_entry): int {.cef_callback.}
