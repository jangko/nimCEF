import cef_base, cef_print_settings
include cef_import
...
type
  ...
  cef_print_handler* = object
    ...
    on_print_settings*: proc(self: ptr cef_print_handler,
      settings: ptr cef_print_settings, get_defaults: int) {.cef_callback.}
  
    # Show the print dialog. Execute |callback| once the dialog is dismissed.
    # Return true (1) if the dialog will be displayed or false (0) to cancel the
    # printing immediately.
    on_print_dialog*: proc(self: ptr cef_print_handler,
      has_selection: int, callback: ptr cef_print_dialog_callback): int {.cef_callback.}
    ...
    on_print_job*: proc(self: ptr cef_print_handler,
      ...
      callback: ptr cef_print_job_callback): int {.cef_callback.}
    ...
    get_pdf_paper_size*: proc(self: ptr cef_print_handler, 
      device_units_per_inch: int): cef_size {.cef_callback.}