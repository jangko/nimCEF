...
type
  cef_print_settings* = object
    ...
    is_valid*: proc(self: ptr cef_print_settings): int {.cef_callback.}
  
    # Returns true (1) if the values of this object are read-only. Some APIs may
    # expose read-only objects.
    is_read_only*: proc(self: ptr cef_print_settings): int {.cef_callback.}
  
    # Returns a writable copy of this object.
    copy*: proc(self: ptr cef_print_settings): ptr cef_print_settings {.cef_callback.}
  
    # Set the page orientation.
    set_orientation*: proc(self: ptr cef_print_settings, landscape: int) {.cef_callback.}
  
    # Returns true (1) if the orientation is landscape.
    is_landscape*: proc(self: ptr cef_print_settings): int {.cef_callback.}
    ...
    set_printer_printable_area*: proc(self: ptr cef_print_settings,
      ...
      landscape_needs_flip: int) {.cef_callback.}
    ...
    set_dpi*: proc(self: ptr cef_print_settings, dpi: int) {.cef_callback.}
  
    # Get the DPI (dots per inch).
    get_dpi*: proc(self: ptr cef_print_settings): int {.cef_callback.}
    ...
    set_selection_only*: proc(self: ptr cef_print_settings,
      selection_only: int) {.cef_callback.}
  
    # Returns true (1) if only the selection will be printed.
    is_selection_only*: proc(self: ptr cef_print_settings): int {.cef_callback.}
  
    # Set whether pages will be collated.
    set_collate*: proc(self: ptr cef_print_settings, collate: int) {.cef_callback.}
  
    # Returns true (1) if pages will be collated.
    will_collate*: proc(self: ptr cef_print_settings): int {.cef_callback.}
    ...
    set_copies*: proc(self: ptr cef_print_settings, copies: int) {.cef_callback.}
  
    # Get the number of copies.
    get_copies*: proc(self: ptr cef_print_settings): int {.cef_callback.}
