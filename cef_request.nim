...
type
  cef_request* = object
    ...
    is_read_only*: proc(self: ptr cef_request): int {.cef_callback.}
    ...
    get_flags*: proc(self: ptr cef_request): int {.cef_callback.}

    # Set the flags used in combination with cef_urlrequest_t.  See
    # cef_urlrequest_flags_t for supported values.
    set_flags*: proc(self: ptr cef_request, flags: int) {.cef_callback.}
  ...
  cef_post_data* = object
    ...
    # Returns true (1) if this object is read-only.
    is_read_only*: proc(self: ptr cef_post_data): int {.cef_callback.}
    ...
    has_excluded_elements*: proc(self: ptr cef_post_data): int {.cef_callback.}
    ...
    remove_element*: proc(self: ptr cef_post_data,
      element: ptr cef_post_data_element): int {.cef_callback.}
  ...
  cef_post_data_element* = object
    ...
    # Returns true (1) if this object is read-only.
    is_read_only*: proc(self: ptr cef_post_data_element): int {.cef_callback.}
