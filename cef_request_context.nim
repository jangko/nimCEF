import cef_base, cef_request_handler, cef_callback, cef_cookie_manager, cef_scheme, cef_values
include cef_import
...
type
  ...
  cef_request_context* = object
    ...
    # object.
    is_same*: proc(self, other: ptr cef_request_context): int {.cef_callback.}

    # Returns true (1) if this object is sharing the same storage as |that|
    # object.
    is_sharing_with*: proc(self, other: ptr cef_request_context): int {.cef_callback.}
  
    # Returns true (1) if this object is the global context. The global context
    # is used by default when creating a browser or URL request with a NULL
    # context argument.
    is_global*: proc(self: ptr cef_request_context): int {.cef_callback.}
    ...
    register_scheme_handler_factory*: proc(self: ptr cef_request_context, 
        ...
        factory: ptr_cef_scheme_handler_factory): int {.cef_callback.}
 
    # Clear all registered scheme handler factories. Returns false (0) on error.
    # This function may be called on any thread in the browser process.
    clear_scheme_handler_factories*: proc(self: ptr cef_request_context): int {.cef_callback.}
    ...
    purge_plugin_list_cache*: proc(self: ptr cef_request_context, reload_pages: int) {.cef_callback.}
  
    # Returns true (1) if a preference with the specified |name| exists. This
    # function must be called on the browser process UI thread.
    has_preference*: proc(self: ptr cef_request_context,
       name: ptr cef_string): int {.cef_callback.}
    ...
    # thread.
    get_all_preferences*: proc(self: ptr cef_request_context, include_defaults: int): ptr cef_dictionary_value {.cef_callback.}
  
    # Returns true (1) if the preference with the specified |name| can be
    # modified using SetPreference. As one example preferences set via the
    # command-line usually cannot be modified. This function must be called on
    # the browser process UI thread.
    can_set_preference*: proc(self: ptr cef_request_context, name: ptr cef_string): int {.cef_callback.}
    ...
    set_preference*: proc(self: ptr cef_request_context,
        ...
        error: ptr cef_string): int {.cef_callback.}
