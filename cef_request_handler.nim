...
type
  ...
  cef_request_callback* = object
    ...
    cont*: proc(self: ptr cef_request_callback, allow: int) {.cef_callback.}
  ...
  cef_request_handler* = object
    ...
    on_before_browse*: proc(self: ptr cef_request_handler,
        ...
        request: ptr cef_request, is_redirect: int): int {.cef_callback.}
    ...
    on_open_urlfrom_tab*: proc(self: ptr cef_request_handler,
        ...
        target_disposition: cef_window_open_disposition, user_gesture: int): int {.cef_callback.}
    ...
    on_resource_response*: proc(self: ptr cef_request_handler,
        browser: ptr_cef_browser, frame: ptr cef_frame,
        request: ptr cef_request, response: ptr cef_response): int {.cef_callback.}
    ...
    get_auth_credentials*: proc(self: ptr cef_request_handler,
        browser: ptr_cef_browser, frame: ptr cef_frame, isProxy: int,
        host: ptr cef_string, port: int, realm: ptr cef_string,
        scheme: ptr cef_string, callback: ptr cef_auth_callback): int {.cef_callback.}
    ...
    on_quota_request*: proc(self: ptr cef_request_handler,
      ...
      new_size: int64, callback: ptr cef_request_callback): int {.cef_callback.}
    ...
    on_protocol_execution*: proc(self: ptr cef_request_handler, browser: ptr_cef_browser,
      url: ptr cef_string, allow_os_execution: var int) {.cef_callback.}
    ...
    on_certificate_error*: proc(self: ptr cef_request_handler,
        ...
        callback: ptr cef_request_callback): int {.cef_callback.}
