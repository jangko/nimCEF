...
type
  ...
  cef_response* = object
    ...
    is_read_only*: proc(self: ptr cef_response): int {.cef_callback.}

    # Get the response status code.
    get_status*: proc(self: ptr cef_response): int {.cef_callback.}

    # Set the response status code.
    set_status*: proc(self: ptr cef_response, status: int) {.cef_callback.}
