...
proc cef_string_list_size*(list: cef_string_list): int {.cef_import.}

# Retrieve the value at the specified zero-based string list index. Returns
# true (1) if the value was successfully retrieved.
proc cef_string_list_value*(list: cef_string_list, index: int, value: ptr cef_string): int {.cef_import.}
