...
type
  ...
  cef_v8context* = object
    ...
    # returns false (0).
    is_valid*: proc(self: ptr cef_v8context): int {.cef_callback.}
    ...
    enter*: proc(self: ptr cef_v8context): int {.cef_callback.}
  
    # Exit this context. Call this function only after calling enter(). Returns
    # true (1) if the scope was exited successfully.
    exit*: proc(self: ptr cef_v8context): int {.cef_callback.}
  
    # Returns true (1) if this object is pointing to the same handle as |that|
    # object.
    is_same*: proc(self, that: ptr cef_v8context): int {.cef_callback.}
    ...
    eval*: proc(self: ptr cef_v8context,
      ...
      exception: ptr ptr cef_v8exception): int {.cef_callback.}
  ...
  cef_v8handler* = object
    ...
    execute*: proc(self: ptr cef_v8handler,
      ...
      retval: ptr ptr cef_v8value, exception: ptr cef_string): int {.cef_callback.}
  ...
  cef_v8accessor* = object
    ...
    set_value*: proc(self: ptr cef_v8accessor,
      name: ptr cef_string, obj: ptr cef_v8value,
      value: ptr cef_v8value, exception: ptr cef_string): int {.cef_callback.}
  ...
  cef_v8exception* = object
    ...
    get_line_number*: proc(self: ptr cef_v8exception): int {.cef_callback.}

    # Returns the index within the script of the first character where the error
    # occurred.
    get_start_position*: proc(self: ptr cef_v8exception): int {.cef_callback.}

    # Returns the index within the script of the last character where the error
    # occurred.
    get_end_position*: proc(self: ptr cef_v8exception): int {.cef_callback.}
  
    # Returns the index within the line of the first character where the error
    # occurred.
    get_start_column*: proc(self: ptr cef_v8exception): int {.cef_callback.}

    # Returns the index within the line of the last character where the error
    # occurred.
    get_end_column*: proc(self: ptr cef_v8exception): int {.cef_callback.}
  ...
  cef_v8value* = object
    ...
    # on the current thread. Do not call any other functions if this function
    # returns false (0).
    is_valid*: proc(self: ptr cef_v8value): int {.cef_callback.}

    # True if the value type is undefined.
    is_undefined*: proc(self: ptr cef_v8value): int {.cef_callback.}

    # True if the value type is null.
    is_null*: proc(self: ptr cef_v8value): int {.cef_callback.}

    # True if the value type is bool.
    is_bool*: proc(self: ptr cef_v8value): int {.cef_callback.}
  
    # True if the value type is int.
    is_int*: proc(self: ptr cef_v8value): int {.cef_callback.}

    # True if the value type is unsigned int.
    is_uint*: proc(self: ptr cef_v8value): int {.cef_callback.}

    # True if the value type is double.
    is_double*: proc(self: ptr cef_v8value): int {.cef_callback.}
  
    # True if the value type is Date.
    is_date*: proc(self: ptr cef_v8value): int {.cef_callback.}
  
    # True if the value type is string.
    is_string*: proc(self: ptr cef_v8value): int {.cef_callback.}
    
    # True if the value type is object.
    is_object*: proc(self: ptr cef_v8value): int {.cef_callback.}
  
    # True if the value type is array.
    is_array*: proc(self: ptr cef_v8value): int {.cef_callback.}

    # True if the value type is function.
    is_function*: proc(self: ptr cef_v8value): int {.cef_callback.}

    # Returns true (1) if this object is pointing to the same handle as |that|
    # object.
    is_same*: proc(self, that: ptr cef_v8value): int {.cef_callback.}

    # Return a bool value.  The underlying data will be converted to if
    # necessary.
    get_bool_value*: proc(self: ptr cef_v8value): int {.cef_callback.}
    ...
    is_user_created*: proc(self: ptr cef_v8value): int {.cef_callback.}

    # Returns true (1) if the last function call resulted in an exception. This
    # attribute exists only in the scope of the current CEF value object.
    has_exception*: proc(self: ptr cef_v8value): int {.cef_callback.}
    ...
    clear_exception*: proc(self: ptr cef_v8value): int {.cef_callback.}
  
    # Returns true (1) if this object will re-throw future exceptions. This
    # attribute exists only in the scope of the current CEF value object.
    will_rethrow_exceptions*: proc(self: ptr cef_v8value): int {.cef_callback.}
    ...
    # exists only in the scope of the current CEF value object.
    set_rethrow_exceptions*: proc(self: ptr cef_v8value, rethrow: int): int {.cef_callback.}

    # Returns true (1) if the object has a value with the specified identifier.
    has_value_bykey*: proc(self: ptr cef_v8value, key: ptr cef_string): int {.cef_callback.}

    # Returns true (1) if the object has a value with the specified identifier.
    has_value_byindex*: proc(self: ptr cef_v8value, index: int): int {.cef_callback.}

    # Deletes the value with the specified identifier and returns true (1) on
    # success. Returns false (0) if this function is called incorrectly or an
    # exception is thrown. For read-only and don't-delete values this function
    # will return true (1) even though deletion failed.
    delete_value_bykey*: proc(self: ptr cef_v8value, key: ptr cef_string): int {.cef_callback.}
  
    # Deletes the value with the specified identifier and returns true (1) on
    # success. Returns false (0) if this function is called incorrectly, deletion
    # fails or an exception is thrown. For read-only and don't-delete values this
    # function will return true (1) even though deletion failed.
    delete_value_byindex*: proc(self: ptr cef_v8value, index: int): int {.cef_callback.}
    ...
    # Returns the value with the specified identifier on success. Returns NULL if
    # this function is called incorrectly or an exception is thrown.
    get_value_byindex*: proc(self: ptr cef_v8value, index: int): ptr cef_v8value {.cef_callback.}
    ...
    set_value_bykey*: proc(self: ptr cef_v8value,
      ...
      attribute: cef_v8_propertyattribute): int {.cef_callback.}

    # Associates a value with the specified identifier and returns true (1) on
    # success. Returns false (0) if this function is called incorrectly or an
    # exception is thrown. For read-only values this function will return true
    # (1) even though assignment failed.
    set_value_byindex*: proc(self: ptr cef_v8value, index: int,
      value: ptr cef_v8value): int {.cef_callback.}
    ...
    set_user_data*: proc(self: ptr cef_v8value,
      user_data: ptr cef_base): int {.cef_callback.}
    ...
    # object.
    get_externally_allocated_memory*: proc(self: ptr cef_v8value): int {.cef_callback.}
    ...
    adjust_externally_allocated_memory*: proc(self: ptr cef_v8value, change_in_bytes: int): int {.cef_callback.}

    # ARRAY METHODS - These functions are only available on arrays.
    # Returns the number of elements in the array.
    get_array_length*: proc(self: ptr cef_v8value): int {.cef_callback.}
  ...
  cef_v8stack_trace* = object
    ...
    # on the current thread. Do not call any other functions if this function
    # returns false (0).
    is_valid*: proc(self: ptr cef_v8stack_trace): int {.cef_callback.}
  
    # Returns the number of stack frames.
    get_frame_count*: proc(self: ptr cef_v8stack_trace): int {.cef_callback.}

    # Returns the stack frame at the specified 0-based index.
    get_frame*: proc(self: ptr cef_v8stack_trace, index: int): ptr cef_v8stack_frame {.cef_callback.}
  ...
  cef_v8stack_frame* = object
    ...
    # on the current thread. Do not call any other functions if this function
    # returns false (0).
    is_valid*: proc(self: ptr cef_v8stack_frame): int {.cef_callback.}
    ...
    get_line_number*: proc(self: ptr cef_v8stack_frame): int {.cef_callback.}

    # Returns the 1-based column offset on the line for the function call or 0 if
    # unknown.
    get_column*: proc(self: ptr cef_v8stack_frame): int {.cef_callback.}

    # Returns true (1) if the function was compiled using eval().
    is_eval*: proc(self: ptr cef_v8stack_frame): int {.cef_callback.}

    # Returns true (1) if the function was called as a constructor via "new".
    is_constructor*: proc(self: ptr cef_v8stack_frame): int {.cef_callback.}
...
proc cef_register_extension*(extension_name: ptr cef_string,
  javascript_code: ptr cef_string, handler: ptr cef_v8handler): int {.cef_import.}
...
proc cef_v8context_in_context*(): int {.cef_import.}
...
proc cef_v8value_create_bool*(value: int): ptr cef_v8value {.cef_import.}
...
# or in combination with calling enter() and exit() on a stored cef_v8context_t
# reference.
proc cef_v8value_create_array*(length: int): ptr cef_v8value {.cef_import.}
...
proc cef_v8stack_trace_get_current*(frame_limit: int): ptr cef_v8stack_trace {.cef_import.}
