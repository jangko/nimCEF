...
type
  ...
  cef_xml_reader* = object
    ...
    move_to_next_node*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
  
    # Close the document. This should be called directly to ensure that cleanup
    # occurs on the correct thread.
    close*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
  
    # Returns true (1) if an error has been reported by the XML parser.
    has_error*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
    ...
    get_depth*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
    ...
    # NULL but <a></a> is not.
    is_empty_element*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
  
    # Returns true (1) if the node has a text value.
    has_value*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
    ...
    has_attributes*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
    ...
    # The resulting string must be freed by calling cef_string_userfree_free().
    get_attribute_byindex*: proc(self: ptr cef_xml_reader, index: int): cef_string_userfree {.cef_callback.}
    ...
    get_line_number*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
    ...
    move_to_attribute_byqname*: proc(self: ptr cef_xml_reader,
      qualifiedName: ptr cef_string): int {.cef_callback.}
  
    # Moves the cursor to the attribute with the specified local name and
    # namespace URI. Returns true (1) if the cursor position was set
    # successfully.
    move_to_attribute_bylname*: proc(self: ptr cef_xml_reader,
      localName, namespaceURI: ptr cef_string): int {.cef_callback.}
  
    # Moves the cursor to the first attribute in the current element. Returns
    # true (1) if the cursor position was set successfully.
    move_to_first_attribute*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
  
    # Moves the cursor to the next attribute in the current element. Returns true
    # (1) if the cursor position was set successfully.
    move_to_next_attribute*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
  
    # Moves the cursor back to the carrying element. Returns true (1) if the
    # cursor position was set successfully.
    move_to_carrying_element*: proc(self: ptr cef_xml_reader): int {.cef_callback.}
