import nc_util, nc_util_impl, cef_life_span_handler_api
...
wrapCallback(NCLifeSpanHandler, cef_life_span_handler):
  ...
  # calling NCBrowserHost::TryCloseBrowser() or
  # NCBrowserHost::CloseBrowser(false (0)) instead of allowing the window
  ...
  # Linux or NCWindowDelegate::CanClose() callback from Views). If the
  ...
  #
  # Example 1: Using NCBrowserHost::TryCloseBrowser(). This is
  ...
  #     is destroyed.
  # 10. Application exits by calling NCQuitMessageLoop() if no other browsers
  #     exist.
  #
  # Example 2: Using NCBrowserHost::CloseBrowser(false (0)) and
  # implementing the DoClose() callback. This is recommended for clients using
