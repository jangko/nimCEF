...
proc ncFree*(ct: cef_time) = discard
...
proc Delta*(ntime1, ntime2: NCTime, delta: var uint64): bool =
  var ct1 = toCef(ntime1)
  var ct2 = toCef(ntime2)
